      ...
      <main className="grow flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="max-w-xl w-full text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
            <a
              href="/"
              className="inline-flex justify-center rounded-md bg-white px-5 py-2.5 text-sm font-medium text-black shadow-sm hover:bg-indigo-700 hover:text-white transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            >
              Go back home
            </a>
            <a
